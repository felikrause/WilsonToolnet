...
namespace EjemploABM
{
    public partial class FormVenta : Form
    {
        ...
        public FormVenta()
        {
            ...
            dataGridViewDisponibles.CellContentClick += dataGridViewDisponibles_CellContentClick;
        ...
        private void AgregarProductoAlCarrito(Producto producto)
        {
            ...
            if (int.TryParse(txtCantidad.Text, out int cantidadSeleccionada))
            {
        ...
        private static void GenerarPDFCliente(Cliente cliente, List<Producto> productosEnCarrito)
        {
            try
            {
                string folderPath = @"C:\Users\Felipe\source\repos\WilsonToolnet\EjemploABM\Recursos\pdf_ventas";
        ...
        private void lblPaginaActual_Click(object sender, EventArgs e)
        {
